...
sub_metering <-  df_data %>% dplyr::select(Date_Time,Sub_metering_1,Sub_metering_2,Sub_metering_3) %>%
  melt(id.vars="Date_Time",variable_name='energy_sub_metering')
names(sub_metering) <- c("Date_Time","Meter","energy_sub_metering")
